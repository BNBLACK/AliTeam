...
cl = CYBERTK.LINE()
cl.login(token="EviiqyLnqnKhCjY6OjG5.VEap/+Rl9qnnTPzEWSeXDq.H4Igz0PpO7rTTisFPxeVdM7Y7oDPUXqCH7f/8KLGSUc=")
cl.loginResult()

ki = CYBERTK.LINE()
ki.login(token="EvJAsRdVKlU3QDfiDyD8.cUJFoJGr3UYty6YBg8bcka.U8Lgxn5m/CgxSvkDbjAduU/fel7aJluGD2njXTEoAAY=")
ki.loginResult()

ki2 = CYBERTK.LINE()
ki2.login(token="EveqBQsxvIEbGxEyKoM0./liouaQP+sXQKxkgUUtUya.P28e556aXozn9HZY5yd79pxJAD2o0J9STvH/1WYGmJU=")
ki2.loginResult()

ki3 = CYBERTK.LINE()
ki3.login(token="EvimpvYFiu6GEzfwGKe6.Tu7EmT8TZNPaEkEQTnL0PG.pAzD2arMGb2l8L+SlebO8IG6g0JvNtZT8QhOboOF0d4=")
ki3.loginResult()

ki4 = CYBERTK.LINE()
ki4.login(token="Evnwpebm2NX9osQ8uIP8.ZsO9J5JHYlZUnoIxBPBnQa.ICGHylxRkqUdSCqv12cTT+giU3ExHcyJrf5/p1OoppI=")
ki4.loginResult()

ki5 = CYBERTK.LINE()
ki5.login(token="EvKVehYqYQtGa1aIN4rd.NfeWDEi6iLtYNOZivRKhhq.+9BGSHV7yu4tOweGOp6a8J9FP7fdhruEd5adxvC0Ng8=")
ki5.loginResult()

print u"Login Success NB"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""=====✍ TEAM BOT NB ✍=====
...
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,"u8cebac436cb7f43c74695e64698551e8","ua0f5e5f5523b2dd4e205fec8068c5d1b","ud2a14e2fd2294cb6af5672ca2c916f67","uff61e1041b5e9119acf267e2bb523872","uc807b5f0ee21ae3edf9e80eab57d21a6"]
admsa = ["u8cebac436cb7f43c74695e64698551e8","ua0f5e5f5523b2dd4e205fec8068c5d1b","ud2a14e2fd2294cb6af5672ca2c916f67","uff61e1041b5e9119acf267e2bb523872","uc807b5f0ee21ae3edf9e80eab57d21a6"]
admin = ["u8cebac436cb7f43c74695e64698551e8","ua0f5e5f5523b2dd4e205fec8068c5d1b","ud2a14e2fd2294cb6af5672ca2c916f67","uff61e1041b5e9119acf267e2bb523872","uc807b5f0ee21ae3edf9e80eab57d21a6"]
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"Thanks For Add ☆ ✍ TEAM BOT NB ✍ ☆ \n\n\Support By ~ ☆ ✍ TEAM BOT NB ✍ ☆ \n\n✯==== Creator ====✯\n\nhttp://line.me/ti/p/~nbteam01",
    "lang":"JP",
    "comment":"Thanks For Add ☆ ✍ TEAM BOT NB ✍ ☆ \n\n☆ ✍ TEAM BOT NB ✍ ☆\n\n✯==== Creator ====✯\n\nhttp://line.me/ti/p/~nbteam01",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u8cebac436cb7f43c74695e64698551e8":
                    if "join:" in msg.text:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                return
            elif msg.text in ["Nb help","help","Help"]:
            	if msg.from_ in admin:
            ...
            elif msg.text in ["NB1 Gift","Bot1 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["NB2 Gift","Bot2 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '3'}
            ...
            elif msg.text in ["NB3 Gift","Bot3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '3'}
            ...
            elif msg.text in ["NB4 Gift","Bot4 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '3'}
            ...
            elif msg.text in ["Cancel","Cancel dong","B cancel"]:
                if msg.toType == 2:
            ...
            elif "NB1 mid" == msg.text:
                ki.sendText(msg.to,kimid)
            elif "NB2 mid" == msg.text:
                ki2.sendText(msg.to,ki2mid)
            elif "NB3 mid" == msg.text:
                ki3.sendText(msg.to,ki3mid)
            elif "NB4 mid" == msg.text:
                ki4.sendText(msg.to,ki4mid)
            elif "NB5 mid" == msg.text:
                ki5.sendText(msg.to,ki5mid)
            elif "NB6 mid" == msg.text:
                ki6.sendText(msg.to,ki6mid)
            elif "NB7 mid" == msg.text:
                ki7.sendText(msg.to,ki7mid)
            elif "NB8 mid" == msg.text:
                ki8.sendText(msg.to,ki8mid)
            elif "NB9 mid" == msg.text:
                ki9.sendText(msg.to,ki9mid)
            elif "NB10 mid" == msg.text:
...
#--------------------------------------------------------                    
                ...
                ki.sendText(msg.to, "☆ ✍ TEAM BOT NB ✍ ☆")
                profile = ki2.getProfile()
                text = profile.displayName + ""
                ki2.sendText(msg.to, "☆ ✍ TEAM BOT NB ✍ ☆")
                profile = ki3.getProfile()
                text = profile.displayName + ""
                ki3.sendText(msg.to, "☆ ✍ TEAM BOT NB ✍ ☆")
                profile = ki4.getProfile()
                text = profile.displayName + ""
                ki4.sendText(msg.to, "☆ ✍ TEAM BOT NB ✍ ☆")
                profile = ki5.getProfile()
                text = profile.displayName + ""
                ki5.sendText(msg.to, "☆ ✍ TEAM BOT NB ✍ ☆")
                profile = ki6.getProfile()
                text = profile.displayName + ""
                ki6.sendText(msg.to, "☆ ✍ TEAM BOT NB ✍ ☆")
                profile = ki7.getProfile()
                text = profile.displayName + ""
                ki7.sendText(msg.to, "☆ ✍ TEAM BOT NB ✍ ☆")
                profile = ki8.getProfile()
                text = profile.displayName + ""
                ki8.sendText(msg.to, "☆ ✍ TEAM BOT NB ✍ ☆")
                profile = ki9.getProfile()
                text = profile.displayName + ""
                ki9.sendText(msg.to, "☆ ✍ TEAM BOT NB ✍ ☆")
                profile = ki10.getProfile()
                text = profile.displayName + ""
                ki10.sendText(msg.to, "☆ ✍ TEAM BOT NB ✍ ☆")
#--------------------------------------------------------                
                ...
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        try:
                            ...
                            pass
            elif "Bubarin" in msg.text:
              if msg.from_ in admin:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Bubarin","")
                    gs = ki.getGroup(msg.to)
                    gs = ki2.getGroup(msg.to)
                    ki.sendText(msg.to,"☆ ✍ TEAM BOT NB ✍ ☆\n\n[TEAM NINJA BLACK]")
                    ki2.sendText(msg.to,"\n\TEAM NINJA BLACK]\n Owner http://line.me//ti/p/~klabakan16")
                    targets = []
                    for g in gs.members:
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
#-----------------------------------------------
            elif "NB key" in msg.text:
                ki.sendText(msg.to,"""      􀜁􀇔􏿿􀜁􀇔􏿿 NB TEAM BOT [NB] ??􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔?? key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[NB1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[NB1 Gift]\n􀜁􀇔􏿿[NB1 bye]\n\n   
  
        
  
☆ ✍ TEAM BOT NB ✍ ☆
""")
                ki2.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿  􀜁􀇔􏿿􀜁􀇔􏿿 NB TEAM BOT [NB] 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[NB1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[NB1 Gift]\n􀜁􀇔􏿿[NB1 bye]\n\n   
        
  
☆ ✍ TEAM BOT NB ✍ ☆
""")
                ki3.sendText(msg.to,"""     􀜁􀇔􏿿 􀜁􀇔􏿿􀜁􀇔􏿿 NB TEAM BOT [NB] 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[NB1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[NB1 Gift]\n􀜁􀇔􏿿[NB1 bye]\n\n   
        
  
☆ ✍ TEAM BOT NB ✍ ☆
""")
                ki4.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿  􀜁􀇔􏿿􀜁􀇔􏿿 NB TEAM BOT [NB] 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[NB1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[NB1 Gift]\n􀜁􀇔􏿿[NB1 bye]\n\n   
        
  
☆ ✍ TEAM BOT NB ✍ ☆
""")
                ki5.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿  􀜁􀇔􏿿􀜁􀇔􏿿 NB TEAM BOT [NB] 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[NB1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[NB1 Gift]\n􀜁􀇔􏿿[NB1 bye]\n\n   
        
  
☆ ✍ TEAM BOT NB ✍ ☆
""")
                ki6.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿  􀜁􀇔􏿿􀜁􀇔􏿿 NB TEAM BOT [NB] 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[NB1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[NB1 Gift]\n􀜁􀇔􏿿[NB1 bye]\n\n   
        g
...
#-----------------------------------------------
            ...
            elif "NB Say " in msg.text:
				bctxt = msg.text.replace("NB Say ","")
